            ...
            <div key={category || 'all'} className="animate-enter">
              {products.length > 0 ? (
                ...
                <div className="h-[400px] flex flex-col items-center justify-center text-center space-y-6 bg-white/5 border border-white/10 rounded-2xl p-8">
                  ...
                  <h2 className="text-3xl font-black uppercase italic text-white">¡Uf! Está vacío por acá</h2>
                  <p className="text-xs font-bold text-muted-foreground tracking-widest uppercase">No encontramos artículos para esta selección.</p>

...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  // Buscamos el producto por slug y la sesión en paralelo
  ...
  // Buscamos opiniones y recomendaciones
  let reviews: any[] = []
  try {
    reviews = await reviewsService.getByProduct(product.id)
  } catch (e) {
  ...
  return (
    <div className="bg-[#050505] min-h-screen text-foreground pb-24">
      <div className="max-w-7xl mx-auto px-6 pt-32 pb-12 lg:pt-40 lg:pb-20">
          ...
          <div className="lg:col-span-5 relative animate-enter" style={{ animationDelay: '300ms' }}>
            <div className="lg:sticky lg:top-32 space-y-10">
              ...
              <ProductInteractiveSection
                ...
                colorVariations={(product as any).color_variations || []}
              />
            </div>
          </div>
        </div>
        ...
        {/* Reviews Section */}
        <div
          className="mt-32 max-w-4xl border-t border-border pt-16 animate-enter"
        ...
        {recommended.length > 0 && (
          <div
            className="mt-32 border-t border-border pt-16 animate-enter"
